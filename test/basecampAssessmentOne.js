...
var responseCreator = function(param){
  ...
  else if (param =="red"){colorResponse = "iheart red";}
  else 
  (param!=green || red);
...
var myName = "Angela"
var myNum = "21"
function greeter(myName, myNum)
{
return "Hi! I am" + myName +"I am" + myNum +"years old";
}